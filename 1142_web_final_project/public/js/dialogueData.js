...
const DIALOGUE = [
  ...
  { type: 'scene', bg: '/bar.png', character: '/figure_man.png', bgm: '/backing_sound.mp3' },  // 咖啡廳主廳，顧北辰入場
  ...
  { type: 'sfx', src: '/sfx_line.mp3' }, // TODO: 放 sfx_line.mp3 至 public/
  ...
  { type: 'sfx', src: '/sfx_door.mp3' }, // TODO: 放 sfx_door.mp3 至 public/
  ...
  // 觸發遊戲 4：鐵管取鑰匙
  { type: 'game', gameId: 4, src: '/game/game4/index.html' },

  // ── 場景 5：倉庫外走廊 ─────────────────────────────
  { type: 'scene', bg: '/out.png', character: '' },

  { type: 'dialogue', speaker: '許以安', text: '終於拿到鑰匙了，趕快去打開大門⋯⋯' },
  { type: 'sfx', src: '/sfx_scare.mp3' }, // TODO: 放 sfx_scare.mp3 至 public/
  { type: 'scene', character: '/figure_man.png' }, // 顧北辰突然出現
